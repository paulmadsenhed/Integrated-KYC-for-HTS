...
1.    The KYC provider
    a. Issues a VC attesting to the user having passed KYC. The VC is downloaded to the user’s wallet app
    b. Sets the KYC flag for the user’s account to ‘true’ using a TokenGrantKYC message 
